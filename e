class Character extends Moveables {
    ...
    // Bilder für Idle und Walk laden
    addMoveImages() {
        for (let i = 0; i < 14; i++) {
    ...
    // Bilder für Schuss-Effekt laden
    addShootFXImages() {
        for (let i = 0; i < 4; i++) {
            let imgNumber = '0' + i;
    ...
    // Wird aufgerufen wenn Enemy den Character trifft
    getHit() {
    ...
    // Tasteneingaben in Bewegung umsetzen
    movement() {
    ...
    // Prüfen ob Character in der Luft ist
    isAboveGround() {
